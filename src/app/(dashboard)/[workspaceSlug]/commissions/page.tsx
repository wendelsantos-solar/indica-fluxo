...
export default async function CommissionsPage({
  params,
  searchParams,
}: PageProps<"/[workspaceSlug]/commissions">) {
            ...
            action={
              status || programId ? (
                <Button asChild variant="secondary">
                  <Link href={`/${workspaceSlug}/commissions`}>Clear filters</Link>
                </Button>
              ) : (
            ...
            >
              ...
              <span className="flex gap-2">
                <Button asChild variant="secondary" size="sm" disabled={page <= 1}>
                  <Link href={`/${workspaceSlug}/commissions?page=${page - 1}`}>Previous</Link>
                </Button>
                <Button asChild variant="secondary" size="sm" disabled={page >= pages}>
                  <Link href={`/${workspaceSlug}/commissions?page=${page + 1}`}>Next</Link>
                </Button>
              </span>
            </nav>
          ) : null}
