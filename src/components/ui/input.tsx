...
export function Input({ className, invalid, ...props }: InputProps) {
  return (
    <input
      ...
      className={cn(
        "h-8 w-full rounded-control border border-border bg-surface-2 px-2.5 text-caption",
...
export function Textarea({
  ...
  return (
    <textarea
      aria-invalid={invalid || undefined}
      className={cn(
        "w-full rounded-control border border-border bg-surface-2 px-2.5 py-2 text-caption",
...
export function Select({
  ...
  return (
    <select
      className={cn(
        "h-8 w-full appearance-none rounded-control border border-border bg-surface-2 px-2.5 pr-8",
        "text-caption text-foreground transition-colors duration-[120ms]",
